...
{
    std::optional<std::uint32_t> MaximumProcessors;
    std::optional<std::uint64_t> MinimumMemoryBytes;
    std::optional<std::uint64_t> MaximumMemoryBytes;
    std::optional<std::uint64_t> MemoryGranularityBytes;
    std::optional<std::uint32_t> MaximumDisks;
    std::map<std::uint32_t, std::uint32_t> ScsiLunsPerController;
    std::optional<std::uint64_t> MaximumSharedMemoryBytes;
    std::optional<std::uint32_t> MaximumFileSystemTagBytes;
};
